...
cur.execute('SELECT id, description FROM Title')
description  = dict()
...
with open('nasaword.js', 'w') as fhand:
...
print("Output written to nasaword.js")
print("Open nasaword.htm in a browser to see the visualization")
